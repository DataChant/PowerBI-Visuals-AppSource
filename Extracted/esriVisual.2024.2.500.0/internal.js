...
exports.EsriVisualAppRoot = "https://la.arcgis.com/powerbi/2024_2";
...
class VisualSettingsModel extends FormattingSettingsModel {
  constructor() {
    ...
    this.cards = [this.mapTools, this.mapControls, this.featureInfo];
  }
...
class MapControlSettings extends FormattingSettingsCard {
  constructor() {
    ...
    this.slices = [this.zoomTools, this.lockMapExtent];
  }
}
